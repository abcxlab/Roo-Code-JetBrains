...
object CommandIds {
    ...
    const val ADD_TO_CONTEXT = "ADD_TO_CONTEXT"
    /** Command ID for creating a new task */
    const val NEW_TASK = "NEW_TASK"
}

/**
 * Constants for prompt types used to look up prompt templates.
 * These are the keys in the `SupportPromptConfigs.configs` map.
 */
object PromptTypes {
    const val EXPLAIN = "EXPLAIN"
    const val FIX = "FIX"
