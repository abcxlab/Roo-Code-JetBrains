...
import com.roocode.jetbrains.terminal.TerminalInstanceManager
...
class MainThreadTerminalShellIntegration(
    ...
    override fun executeCommand(terminalId: Int, commandLine: String) {
        logger.debug("🚀 Executing Shell Integration command: terminalId=$terminalId, commandLine='$commandLine'")
        ...
        try {
            ...
            logger.debug("✅ Found terminal instance: ${terminalInstance.extHostTerminalId}")
            
            // Execute command in terminal
            terminalInstance.sendText(commandLine, shouldExecute = true)
            
            logger.debug("✅ Command sent to terminal: terminalId=$terminalId, command='$commandLine'")
    ...
    override fun dispose() {
        logger.debug("🧹 Destroying MainThreadTerminalShellIntegration")
    }
}
