...
class MainThreadFileSystem : MainThreadFileSystemShape {
    ...
    override fun registerFileSystemProvider(handle: Int, scheme: String) {
        logger.debug("Registering file system provider: handle=$handle, scheme=$scheme")
    ...
    override fun unregisterProvider(handle: Int) {
        logger.debug("Unregistering file system provider: handle=$handle")
    ...
    override fun stat(resource: URI): FileStat {
        logger.debug("Getting file status information: $resource")
    ...
    override fun readdir(resource: URI): List<Pair<String, String>> {
        logger.debug("Reading directory contents: $resource")
    ...
    override fun readFile(uri: URI): ByteArray {
        logger.debug("Reading file content: $uri")
    ...
    override fun writeFile(uri: URI, content: ByteArray, overwrite: Boolean): ByteArray {
        logger.debug("Writing file content: $uri, content size: ${content.size} bytes")
    ...
    override fun rename(source: URI, target: URI, options: Map<String, Any>) {
        logger.debug("Renaming: $source -> $target")
    ...
    override fun delete(uri: URI, options: Map<String, Any>) {
        logger.debug("Deleting: $uri, options: $options")
    ...
    override fun ensureActivation(scheme: String) {
        logger.debug("Ensuring activation: $scheme")
    ...
    override fun onFileSystemChange(handle: Int, resources: List<FileChangeDto>) {
        logger.debug("File system change notification: handle=$handle, resources=${resources.joinToString { it.resource.toString() }}")
    ...
    override fun dispose() {
        logger.debug("Disposing MainThreadFileSystem resources")
        providers.clear()
    }
}
