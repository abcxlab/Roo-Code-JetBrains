...
class TerminalInstanceManager : Disposable {
    ...
    fun registerTerminal(extHostTerminalId: String, terminalInstance: TerminalInstance) {
        ...
        terminalInstance.addTerminalCloseCallback {
            logger.debug("🔔 Received terminal close event callback: $extHostTerminalId")
        ...
        logger.debug("📝 Registered terminal instance: $extHostTerminalId (numericId: ${terminalInstance.numericId})")
    }
    ...
    fun unregisterTerminal(extHostTerminalId: String): TerminalInstance? {
        ...
        if (terminalInstance != null) {
            ...
            logger.debug("🗑️ Unregistered terminal instance: $extHostTerminalId (numericId: ${terminalInstance.numericId})")
        }
    ...
    override fun dispose() {
        logger.debug("🧹 Disposing terminal instance manager")
        ...
        try {
            ...
            logger.debug("✅ Terminal instance manager disposed")
