...
package com.roocode.jetbrains.ipc.proxy.logger

import com.intellij.openapi.Disposable
import com.intellij.openapi.diagnostic.Logger
import com.roocode.jetbrains.ipc.proxy.IRPCProtocolLogger
import com.roocode.jetbrains.ipc.proxy.RequestInitiator
   ...
   private val isEnabled = false
    ...
    init {
        if(!isEnabled) {
           ...
           logger.debug("FileRPCProtocolLogger initialized successfully, log file: ${logFile?.absolutePath}")
        }
    }
    ...
    override fun dispose() {
        ...
        try {
           ...
           logger.debug("FileRPCProtocolLogger released")
        } catch (e: Exception) {
