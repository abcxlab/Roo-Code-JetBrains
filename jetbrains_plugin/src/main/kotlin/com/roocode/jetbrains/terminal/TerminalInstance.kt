...
import com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostTerminalShellIntegrationProxy
import com.roocode.jetbrains.ipc.proxy.interfaces.ShellLaunchConfigDto
...
class TerminalInstance(
    ...
    private fun finalizeInitialization() {
        ...
        logger.debug("✅ Terminal instance initialization complete: $extHostTerminalId")
    ...
    private fun createTerminalWidget() {
        try {
            ...
            logger.debug("✅ Terminal widget created successfully")
    ...
    override fun dispose() {
        ...
        logger.debug("🧹 Disposing terminal instance: $extHostTerminalId")
        ...
        try {
            ...
            logger.debug("✅ Terminal instance disposed: $extHostTerminalId")
        } catch (e: Exception) {
