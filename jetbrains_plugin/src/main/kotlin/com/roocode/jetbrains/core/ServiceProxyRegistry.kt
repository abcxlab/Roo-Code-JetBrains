...
import com.roocode.jetbrains.ipc.proxy.createProxyIdentifier
import com.roocode.jetbrains.ipc.proxy.interfaces.*
...
class ServiceProxyRegistry private constructor() {
    ...
    private fun initializeAllProxies() {
        logger.debug("Initialize all proxy identifiers")
        ...
        logger.debug("Initialized ${mainThreadProxies.size} main thread services and ${extHostProxies.size} extension host services")
    }
    ...
    object MainContext {
        ...
        val MainThreadDiagnostics = createProxyIdentifier<MainThreadDiagnosticsShape>("MainThreadDiagnostics")
    ...
    object ExtHostContext {
        ...
        val ExtHostCommands = createProxyIdentifier<ExtHostCommandsProxy>("com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostCommandsProxy")
        val ExtHostConfiguration = createProxyIdentifier<ExtHostConfigurationProxy>("com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostConfigurationProxy")
        val ExtHostDiagnostics = createProxyIdentifier<ExtHostDiagnosticsProxy>("com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostDiagnosticsProxy")
        ...
        val ExtHostDocumentsAndEditors = createProxyIdentifier<ExtHostDocumentsAndEditorsProxy>("com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostDocumentsAndEditorsProxy")
        val ExtHostDocuments = createProxyIdentifier<ExtHostDocumentsProxy>("com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostDocumentsProxy")
        ...
        val ExtHostEditors = createProxyIdentifier<ExtHostEditorsProxy>("com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostEditorsProxy")
        ...
        val ExtHostFileSystemEventService = createProxyIdentifier<ExtHostFileSystemEventServiceProxy>("com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostFileSystemEventServiceProxy")
        ...
        val ExtHostExtensionService = createProxyIdentifier<ExtHostExtensionServiceProxy>("com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostExtensionServiceProxy")
        val ExtHostLogLevelServiceShape = createProxyIdentifier<Any>("ExtHostLogLevelServiceShape")
        val ExtHostTerminalService = createProxyIdentifier<ExtHostTerminalServiceProxy>("com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostTerminalServiceProxy")
        val ExtHostTerminalShellIntegration = createProxyIdentifier<ExtHostTerminalShellIntegrationProxy>("com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostTerminalShellIntegrationProxy")
        ...
        val ExtHostWorkspace = createProxyIdentifier<ExtHostWorkspaceProxy>("com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostWorkspaceProxy")
        val ExtHostWindow = createProxyIdentifier<Any>("ExtHostWindow")
        val ExtHostWebviews = createProxyIdentifier<ExtHostWebviewsProxy>("com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostWebviewsProxy")
        ...
        val ExtHostWebviewViews = createProxyIdentifier<ExtHostWebviewViewsProxy>("com.roocode.jetbrains.ipc.proxy.interfaces.ExtHostWebviewViewsProxy")
