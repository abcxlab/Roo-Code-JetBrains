...
import com.roocode.jetbrains.core.ExtensionManager
...
class MainThreadExtensionService(
    ...
    override fun getExtension(extensionId: Any): Any? {
        ...
        logger.debug("Retrieving extension: $extensionIdStr")
    ...
    override fun activateExtension(extensionId: Any, reason: Any?): Any {
        ...
        logger.debug("Activating extension: $extensionIdStr, reason: $reason")
        ...
        return try {
            ...
            logger.debug("Extension $extensionIdStr activation ${if (result) "successful" else "failed"}")
            true
        } catch (e: Exception) {
    ...
    override fun onWillActivateExtension(extensionId: Any) {
        ...
        logger.debug("Extension $extensionIdStr is about to be activated")
    }
    ...
    override fun onDidActivateExtension(
        ...
        logger.debug("Extension $extensionIdStr activated, reason: $activationReason")
    }
    ...
    override fun setPerformanceMarks(marks: List<Any>) {
        logger.debug("Setting performance marks: $marks")
    }
    ...
    override fun asBrowserUri(uri: URI): URI {
        logger.debug("Converting to browser URI: $uri")
        return uri
    }
    ...
    override fun dispose() {
        logger.debug("Disposing MainThreadExtensionService")
    }
}
