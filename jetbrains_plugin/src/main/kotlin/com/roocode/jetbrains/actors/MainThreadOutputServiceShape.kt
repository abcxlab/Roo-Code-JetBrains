...
class MainThreadOutputService : MainThreadOutputServiceShape {
    ...
    override suspend fun register(label: String, file: Map<String, Any>, languageId: String?, extensionId: String): String {
        logger.debug("Register output channel: label=$label, file=$file, extensionId=$extensionId")
    ...
    override suspend fun update(channelId: String, mode: Int, till: Int?) {
        logger.debug("Update output channel: channelId=$channelId, mode=$mode, till=$till")
    }
    ...
    override suspend fun reveal(channelId: String, preserveFocus: Boolean) {
        logger.debug("Reveal output channel: channelId=$channelId, preserveFocus=$preserveFocus")
    }
    ...
    override suspend fun close(channelId: String) {
        logger.debug("Close output channel: channelId=$channelId")
    }
    ...
    override suspend fun dispose(channelId: String) {
        logger.debug("Disposing output channel: channelId=$channelId")
    }
    ...
    override fun dispose() {
        logger.debug("Disposing all output channel resources")
    }
} 
