...
class MainThreadMessageService : MainThreadMessageServiceShape {
    ...
    override fun showMessage(
        ...
        logger.debug("showMessage - severity: $severity, message: $message, options: $options, commands: $commands")
    ...
    private fun showModalMessage(
        ...
        ApplicationManager.getApplication().invokeAndWait {
            val selectedIdx = Messages.showDialog(
                project,
                dialogMessage,
                options["source"]?.let { (it as? Map<*, *>)?.get("label")?.toString() } ?: "RooCode",
    ...
    private fun showNotificationMessage(
        ...
        val notification = NotificationGroupManager.getInstance().getNotificationGroup("RooCode").createNotification(
            message,
            notificationType
        )
