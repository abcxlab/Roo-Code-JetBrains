...
class MainThreadDebugService : MainThreadDebugServiceShape {
    ...
    override fun acceptDAError(handle: Int, name: String, message: String, stack: String?) {
        logger.debug("Received debug adapter error: handle=$handle, name=$name, message=$message, stack=$stack")
    }
    ...
    override fun registerDebugConfigurationProvider(
        ...
        logger.debug("Registering debug configuration provider: type=$type, triggerKind=$triggerKind, " +
    ...
    override fun startDebugging(folder: URI?, nameOrConfig: Any, options: Any): Any {
        logger.debug("Starting debugging: folder=$folder, nameOrConfig=$nameOrConfig, options=$options")
        return true
    }
    
    override fun stopDebugging(sessionId: String?): Any {
        logger.debug("Stopping debugging: sessionId=$sessionId")
        return Unit
    }
    ...
    override fun customDebugAdapterRequest(id: String, command: String, args: Any): Any {
        logger.debug("Custom debug adapter request: id=$id, command=$command, args=$args")
        return Unit
    }
    ...
    override fun appendDebugConsole(value: String) {
        logger.debug("Appending to debug console: $value")
    }
    ...
    override fun dispose() {
        logger.debug("Disposing MainThreadDebugService")
    }
}
